...
class Tests_with_paths(object):
    def setup(self):
        ...
        self.testcsvpath = helpers.test_data_path('testtable.csv')
    ...
    def test_makeBoxplotLegend(self):
        reportutils.makeBoxplotLegend(helpers.test_data_path('bplegendtest'))
    ...
    def test_makeTablesFromCSVStrings(self):
        reportutils.makeTablesFromCSVStrings(self.tablestring,
                    texpath=helpers.test_data_path('testtable.tex'),
    ...
    def test_csvToTex(self):
        ...
        reportutils.csvToTex(self.testcsvpath, helpers.test_data_path(testfile))
        ...
        with open(helpers.test_data_path(testfile), 'r') as test, \
             open(helpers.test_data_path(knownfile), 'r') as known:
            assert test.read() == known.read()

    def test_csvToXlsx(self):
        reportutils.csvToXlsx(self.testcsvpath, helpers.test_data_path('testtable_toXL.xlsx'))

...
def test_fit(uselog):
    ...
    expected = {
        False: {
            'yhat': numpy.array([5.841, 6.763, 7.685, 8.606, 9.528,
                                 10.450, 11.371, 12.293, 13.215, 14.136]),
            'lower': numpy.array([3.449, 4.855, 6.166, 7.181, 8.088,
                                  8.954, 9.816, 10.561, 11.119, 11.591]),
            'upper': numpy.array([9.948, 10.233, 10.562, 10.913, 11.542,
                                  12.527, 13.901, 15.545, 17.218, 18.940]),
        },
        True: {
            'yhat': numpy.array([4.004, 5.858, 7.318, 8.570, 9.686,
                                 10.706, 11.651, 12.537, 13.374, 14.170]),
            'lower': numpy.array([2.172, 3.961, 5.636, 7.079, 8.255,
                                  9.218, 10.060, 10.760, 11.280, 11.660]),
            'upper': numpy.array([8.048, 9.080, 9.882, 10.589, 11.429,
                                  12.494, 13.871, 15.438, 17.124, 18.713]),
        }
    }
